export function buildDesktopTornClipPath(steps = 80) {
  let d = "M 0 0 L 1 0";
...
export function buildMobileTornClipPath(steps = 80) {
...
export function LandingTornClipDefs() {
  return (
    ...
    >
      <defs>
        <clipPath id="landing-split-desktop" clipPathUnits="objectBoundingBox">
