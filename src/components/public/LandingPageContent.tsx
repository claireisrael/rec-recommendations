...
interface LandingPageContentProps {
  className?: string;
  /** Curtain preview — static, no slow photo zoom */
  preview?: boolean;
}
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link href="/login" className="group">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto h-12 px-8 border-white/25 text-white hover:bg-white/10 hover:text-white transition-all duration-300 group-hover:scale-[1.03]"
              >
                Admin Login
              </Button>
            </Link>
